...
export default function Stacks() {
  ...
  return (
    <div className="bg-white p-8 overflow-hidden">
      <InfiniteMovingCards items={firstHalf} direction="left" speed="slow" />
      <InfiniteMovingCards items={secondHalf} direction="right" speed="slow" />
      <InfiniteMovingCards items={thirdHalf} direction="left" speed="slow" />
    </div>
  );
}
