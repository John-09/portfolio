  ...
  return (
    ...
    >
      ...
      >
        {items.map((item) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-4 flex-shrink-0 border-slate-700 px-8 py-6 md:w-[450px]"
            style={{
              background:
          ...
          >
           ...
           <div className="relative z-20 mt-6 flex flex-col items-center justify-center h-full">
            <span className="flex flex-col gap-1 text-center">
              <span className="text-sm leading-[1.6] font-bold text-gray-900">
                {item.name}
              </span>
          ...
          <img src={item.image} alt={item.name} className="w-50 h-50 pt-3 object-cover rounded-lg" />
          </div>
